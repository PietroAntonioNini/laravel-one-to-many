<section>
    <header>
        <h2 class="text-secondary text-white">
            {{ __('Informazioni del Profilo') }}
        </h2>

        <p class="mt-1 text-muted text-white">
            {{ __("Aggiorna le info del tuo profilo e l'indirizzo email.") }}
        </p>
    </header>
            ...
            <div>
                <p class="text-sm mt-2 text-muted">
                    ...
                    <button form="send-verification" class="btn btn-outline-dark">
                        {{ __('Clicca qui per inviare un nuovo email di verifica.') }}
                    </button>
                </p>
